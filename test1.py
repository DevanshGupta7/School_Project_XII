...
Test'''
    ...
    def services_screen(self, width, height):        
        ...
        self.service1_frame.bind("<Button-1>", self.on_press_main)
        self.service1_frame.bind("<ButtonRelease-1>", self.on_release_main)
        self.service1_frame.place(relx=0.50, y=350, anchor=tk.CENTER)
        
        self.service1_Button = tk.Button(self.inner_frame, text=self.service1_text, font=("Helvetica", 50, "italic"), bg="#22215b", fg="white", bd=0, command=lambda: self.load_service1_screen(width, height))
        self.service1_Button.bind("<Button-1>", self.on_press_main)
        self.service1_Button.bind("<ButtonRelease-1>", self.on_release_main)
        ...
        self.service2_frame.bind("<Button-1>", self.on_press_main)
        self.service2_frame.bind("<ButtonRelease-1>", self.on_release_main)
        ...
        self.service2_Button.bind("<Button-1>", self.on_press_main)
        self.service2_Button.bind("<ButtonRelease-1>", self.on_release_main)
        ...
        self.service3_frame.bind("<Button-1>", self.on_press_main)
        self.service3_frame.bind("<ButtonRelease-1>", self.on_release_main)
        ...
        self.service3_Button.bind("<Button-1>", self.on_press_main)
        self.service3_Button.bind("<ButtonRelease-1>", self.on_release_main)
