...
Test'''
    ...
    def services_screen(self, width, height):
        ...
        self.header_photo_label.place(relx=0.5, rely=0.5, anchor=tk.CENTER)

        self.main_heading = tk.Label(self.header, text="Eye Testing", font=("Helvetica", 35, "italic"), bg="#8a2f61", fg="#FFFF00")
        self.main_heading.place(relx=0.15, rely=0.5, anchor=tk.CENTER)
        ...
        self.scrollbar.place(relx=1, rely=1, anchor=tk.SE, height=height-header_image_height)
        ...
        self.service1_frame.bind("<Button-1>", self.on_press)
        self.service1_frame.bind("<ButtonRelease-1>", self.on_release)
        self.service1_frame.pack(fill=tk.Y)
        ...
        self.bg_photo_label.pack(side=tk.BOTTOM, fill=tk.X)  # Positioned at the bottom of main_frame
