...
Test'''
    ...
    def services_screen(self, width, height):        
        ...
        header_image = Services.resource_path("assets/Images/background-gradient-lights.jpg")
        ...
        bg_image = Services.resource_path("assets/Images/background_footer.jpg")
        ...
        snellen_chart = Services.resource_path("assets/Images/snellen_chart.jpg")
        snellen_chart = Image.open(snellen_chart)
        ...
        ishira_image = Services.resource_path("assets/Images/ishihara_image.png")
        ishira_image = Image.open(ishira_image)
